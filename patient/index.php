                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <p>Haven't any idea about doctor? no problem let's jumping to 
                                <a class="non-style-link"><b>Appointment Session</b></a> section or 
                                    ...
                                    <center>
                                        ...
                                        <tbody>
                                            ...
                                            $nextweek=date("Y-m-d",strtotime("+1 week"));
                                                $sqlmain= "select * from schedule inner join appointment on schedule.scheduleid=appointment.scheduleid inner join patient on patient.pid=appointment.pid inner join doctor on schedule.docid=doctor.docid  where  patient.pid=$userid and appointment.status='Pending'  and schedule.scheduledate>='$today' order by schedule.scheduledate asc";
                                                //echo $sqlmain;
