                            ...
                            if(($_GET)){
                                ...
                                if(isset($_GET["id"])){
                                    ...
                                    <td style="width: 50%;" rowspan="2">
                                        ...
                                        <tr>
                                            <td>
                                            <div  class="dashboard-items search-items" style="display:flex;
                                            flex-direction: column;" >
                                           <label style="margin-left:35px"><b>Upload X-Ray Here:- </b></label>
                                            <input type="file" name="x_ray" style="margin-left:10px;padding-left: 25px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px;width:95%;text-align: center;"><br>

                                            <label style="margin-left:35px; margin-bottom:10px"><b>Select Treatment:-</b></label>
                                            <select name="treatment">
                                                <option name="DC" value="Dental Cleanings">Dental Cleanings</option>
                                                <option name="Fill" value="Fillings">Fillings</option>
                                                <option name="Extra" value="Extractions">Extractions</option>
                                                <option name="Root" value="Root Canals">Root Canals</option>
                                                <option name="DE" value="Dental Examinations">Dental Examinations</option>
                                            </select>
                                            <div style=" margin-top:15px; margin-bottom:15px; margin-left:35px">
                                           Emergency <input type="radio" name="emergency" value="Yes">
                                            Ordinary<input type="radio" name="emergency" value="No">
                                            </div>
