                                ...
                                if($result->num_rows==0){
                                    ...
                                    for ( $x=0; $x<($result->num_rows);$x++){
                                        ...
                                        for($q=0;$q<3;$q++){
                                            ...
                                            $appoid=$row["appoid"];
                                            //get the status of the appointment for particular appoid
                                            $status_res= $database->query("select status from appointment where appoid='$appoid'");
                                                    ...
                                                    <div  class="dashboard-items search-items"  >
                                                        ...
                                                        <div class="h3-search">
                                                                ...
                                                                if($status=="Done"){
                                                                    ...
                                                                    <a ><button  class="login-btn btn-primary-soft btn "  style="padding-top:11px;padding-bottom:11px;width:100%"><font class="tn-in-text">Appointment Done</font></button></a>
                                                            </div>';
                                                                }else{
                                                                    echo'
