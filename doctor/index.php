                                                ...
                                                <td style="width: 25%;">
                                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex; ">
                                                        <div>
                                                                ...
                                                                <div class="btn-icon-back dashboard-icons" style="margin-left: 40px;background-image: url('../img/icons/book-hover.svg');"></div>
                                                    </div>
                                                ...
                                                <td style="width: 25%;">
                                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex;padding-top:21px;padding-bottom:21px;">
                                                        <div>
                                                                ...
                                                                <div class="btn-icon-back dashboard-icons" style="margin-left: 40px; background-image: url('../img/icons/session-iceblue.svg');"></div>
                                                    </div>
                                                </td>
